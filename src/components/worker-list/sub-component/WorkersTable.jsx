...
const WorkersTable = () => {
  const WorkersData = [
    {
      Name: "Hussain Burhani",
      WorkerType: "Technician",
      Onbordngdate: "25 mar, 2024",
    },
    {
      Name: "Jubed Ansari",
      WorkerType: "Technician",
            ...
            <table className="table table-row-dashed">
              <thead>
                <tr>
                  ...
                  <th className="w-150px text-start">Type of Worker</th>
                  <th className="w-150px text-start">Onboarding Date</th>
                ...
                {WorkersData.map((item, idx) => {
                  return (
                    <tr key={item.orderId} className="">
                      ...
                      <td className="text-start">
                        <span className="">{item.WorkerType}</span>
                      </td>
                      <td className="text-start">
                        <span>{item.Onbordngdate}</span>
                      </td>
                        ...
                        <div className="action-main">
                          ...
                          <div className="action-inner">
                            <div class="action-btn">
                              <Link to="/edit-worker" className="edit-action">
                                <svg
                                  width="20"
                                  height="19"
                                  viewBox="0 0 20 19"
